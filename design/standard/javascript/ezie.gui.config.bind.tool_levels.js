...
ezie.gui.config.bind.tool_levels_show = function() {
    $.log('starting levels');
    ezie.gui.eziegui.getInstance().opts().showOpts("#optsLevels");
}

ezie.gui.config.bind.tool_levels_submit = function() {
...
ezie.gui.config.bind.tool_levels_preview = function(channel) {
